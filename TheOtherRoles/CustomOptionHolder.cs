...
namespace TheOtherRoles {
    public class CustomOptionHolder {
     ...
     //   public static CustomOption lawyerTarget;
        ...
        //public static CustomOption werewolfRampagedVision;
        //public static CustomOption werewolfVision;
   ...
   //     public static CustomOption NoGameEndImp;
    //    public static CustomOption NoGameEndElse;
...
//            prosecutorPreferAmnesiac = CustomOption.Create(8701, Types.Neutral, "Prefer Amnesiac over Pursuer", false, prosecutorSpawnRate);
     ...
     //       lawyerTarget = CustomOption.Create(351, Types.Neutral, "Lawyer Client", new string[] { "Any", "Non-Crew", "Crew" }, lawyerSpawnRate);
            ...
            //werewolfRampagedVision = CustomOption.Create(1505, Types.Neutral, "Rampage Vision", 2f, 0.25f, 5f, 0.25f, werewolfSpawnRate);
          //  werewolfVision = CustomOption.Create(1506, Types.Neutral, "Werewoolf Vision", 0.75f, 0.25f, 5f, 0.25f, werewolfSpawnRate);
            ...
            engineerResetFixAfterMeeting = CustomOption.Create(9111, Types.Crewmate, "Reset Fix After Meeting", false, engineerSpawnRate);
	    ...
	    veterenAlertDuration = CustomOption.Create(452, Types.Crewmate, "Alert Duration", 3f, 1f, 20f, 1f, veterenSpawnRate);
            ...
            modifierAssassin = CustomOption.Create(2000, Types.Modifier, cs(Color.red, "Assassin"), rates, null, true);
            modifierAssassinQuantity = CustomOption.Create(2001, Types.Modifier, cs(Color.yellow, "Assassin Quantity"), ratesModifier, modifierAssassin);
            modifierAssassinNumberOfShots = CustomOption.Create(2002, Types.Modifier, "Number Of Shots", 5f, 1f, 15f, 1f, modifierAssassin);
            modifierAssassinMultipleShotsPerMeeting = CustomOption.Create(2003, Types.Modifier, "Can Shoot Multiple Times Per Meeting", true, modifierAssassin);
            guesserEvilCanKillSpy = CustomOption.Create(2004, Types.Modifier, "Can Guess The Spy", true, modifierAssassin);
            guesserEvilCanKillCrewmate = CustomOption.Create(20045, Types.Modifier, "Can Guess Crewmate", true, modifierAssassin);
            guesserCantGuessSnitchIfTaksDone = CustomOption.Create(2005, Types.Modifier, "Can't Guess Snitch When Revealed", true, modifierAssassin);
            modifierAssassinKillsThroughShield = CustomOption.Create(2006, Types.Modifier, "Guesses Ignore The Medic Shield", false, modifierAssassin);
           ...
           // modifierTorchQuantity = CustomOption.Create(1055, Types.Modifier, "Vision With Torch", new string[] { "+10%", "+20%", "+30%", "+40%", "+50%" }, modifierTorch);
