    ...
    public class GameStartManagerUpdatePatch {
        ...
        public static void Postfix(GameStartManager __instance) {
            ...
            // Client update with handshake infos
                ...
                if (!HandshakeHelper.playerVersions.ContainsKey(AmongUsClient.Instance.HostId) || Main.Version.CompareTo(HandshakeHelper.playerVersions[AmongUsClient.Instance.HostId].version) != 0) {
                ...
                if (CustomOptionHolder.anyPlayerCanStopStart.getBool() && copiedStartButton == null && IsStart(__instance)) {
    ...
    public class GameStartManagerBeginGame {
        public static bool Prefix(GameStartManager __instance) {
            ...
            foreach (var client in AmongUsClient.Instance.allClients.GetFastEnumerator()) {
                ...
                if (!HandshakeHelper.playerVersions.ContainsKey(client.Id)) {
                    continueStart = false;
                    break;
                }
                        
                var PV = HandshakeHelper.playerVersions[client.Id];
