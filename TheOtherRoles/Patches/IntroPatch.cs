...
namespace TheOtherRoles.Patches
{
    ...
    class IntroCutsceneOnDestroyPatch
    {
        ...
        public static void Prefix(IntroCutscene __instance)
        {
            ...
            if (CachedPlayer.LocalPlayer != null && FastDestroyableSingleton<HudManager>.Instance != null)
            {
                ...
                foreach (PlayerControl p in CachedPlayer.AllPlayers)
                {
                    ...
                    PoolablePlayer player = UnityEngine.Object.Instantiate<PoolablePlayer>(__instance.PlayerPrefab,
            ...
            if (BountyHunter.bounty != null && CachedPlayer.LocalPlayer.PlayerControl == BountyHunter.bountyHunter)
            {
                ...
                {
                    BountyHunter.cooldownText = UnityEngine.Object.Instantiate<TMPro.TextMeshPro>(
            ...
            if (CustomOptionHolder.randomGameStartPosition.getBool())
            {
                ...
                // First kill
                if (AmongUsClient.Instance.AmHost && TORMapOptions.shieldFirstKill &&
                    TORMapOptions.firstKillName != "" && !HideNSeek.isHideNSeekGM && !PropHunt.isPropHuntGM)
                {
                    ...
                    if (target != null)
                    {
                        var writer = AmongUsClient.Instance.StartRpcImmediately(
                            CachedPlayer.LocalPlayer.PlayerControl.NetId, (byte)CustomRPC.SetFirstKill,
                ...
                if (HideNSeek.isHideNSeekGM)
                {
                    foreach (PlayerControl player in HideNSeek.getHunters())
                    {
                        ...
                        FastDestroyableSingleton<HudManager>.Instance.StartCoroutine(Effects.Lerp(
                            HideNSeek.hunterWaitingTime, new Action<float>((p) =>
                            {
                                if (p == 1f)
                                {
                    ...
                    if (HideNSeek.polusVent == null && GameOptionsManager.Instance.currentNormalGameOptions.MapId == 2)
                    {
                        ...
                        HideNSeek.polusVent.gameObject.AddSubmergedComponent(SubmergedCompatibility.Classes
                            .ElevatorMover);
                        ...
                        HideNSeek.polusVent.Id =
                            MapUtilities.CachedShipStatus.AllVents.Select(x => x.Id).Max() +
                            1; // Make sure we have a unique id
        ...
        class IntroPatch
        {
            ...
            {
                public static void Postfix(IntroCutscene __instance, bool impostorPositioning,
            ...
            class SetUpRoleTextPatch
            {
                ...
                static public void SetRoleTexts(IntroCutscene __instance)
                {
                    ...
                    if (EventUtility.isEnabled)
                    {
                        ...
                        if (roleInfo.color == Palette.ImpostorRed)
                            roleInfos.RemoveAll(x => x.color != Palette.ImpostorRed);
                    ...
                    if (modifierInfo != null)
                    {
                        ...
                        {
                            PlayerControl otherLover = CachedPlayer.LocalPlayer.PlayerControl == Lovers.lover1
                                ? Lovers.lover2
                                : Lovers.lover1;
        ...
        public static class ShouldShowAprilFoolsToggle
        {
            public static void Postfix(ref bool __result)
            {
                __result = __result || EventUtility.isEventDate ||
                           EventUtility
                               .canBeEnabled; // Extend it to a 7 day window instead of just 1st day of the Month
            }
        }
    }
}
