   ...
   //     }
        ...
        public static void updatePlayerInfo() {
            foreach (PlayerControl p in CachedPlayer.AllPlayers) {         
                if ((Lawyer.lawyerKnowsRole && CachedPlayer.LocalPlayer.PlayerControl == Lawyer.lawyer && p == Lawyer.target) || p == CachedPlayer.LocalPlayer.PlayerControl || CachedPlayer.LocalPlayer.Data.IsDead || ((CachedPlayer.LocalPlayer.PlayerControl == Slueth.slueth && Slueth.reported.Any(x => x.PlayerId == p.PlayerId))) || MapOptions.impostorSeeRoles && CachedPlayer.LocalPlayer.Data.Role.IsImpostor && p == p.Data.Role.IsImpostor) {
