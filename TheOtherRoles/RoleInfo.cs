...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo torch = new RoleInfo("Torch", Color.yellow, "You got the torch", "You can see in the dark", RoleId.Sunglasses, false, true);
        ...
        public static RoleInfo slueth  = new RoleInfo("Sleuth", Color.yellow, "Learn the roles of bodies you report", "Who dat?", RoleId.Indomitable, false, true);
       ...
       // public static RoleInfo assassin = new RoleInfo("", Color.yellow, "", "", RoleId.EvilGuesser, false, true);
