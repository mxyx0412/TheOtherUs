...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo bodyguard  = new RoleInfo("Body Guard", BodyGuard.color, "Switch places with your chosen target if they are killed", "Protect someone with your own life", RoleId.BodyGuard, false);
